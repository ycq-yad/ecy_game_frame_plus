...
export class HttpManager {
    private static instance_: HttpManager;
    ...
    public sendGetHttpReq(url: string, data: any = null,
     ...
     */
    public sendHttpReqDY(url: string, data: any = null,
        secces: Function = null, fail: Function = null,
     ...
     * @param type 请求类型 默认post
     */
    public sendPostHttpReq(url: string, data: any = null,
        secces: Function = null, fail: Function = null,
     ...
     * @param responseType 返回值类型 默认 text
     */
    public sendHttpReq(url: string, data: any = null,
        secces: Function = null, fail: Function = null,
