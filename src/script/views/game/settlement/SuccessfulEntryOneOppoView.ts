...
import SuccessfulEntryThreeOppoView from "./SuccessfulEntryThreeOppoView";

export default class SuccessfulEntryOneOppoView extends PopBaseScene {

    public className_key = "SuccessfulEntryOneOppoView";
    ...
    public btn_countinue: Laya.Sprite;
    ...
    private procLogicOver() {
        ...
        Laya.timer.once(1000, this, () => {
            this.btn_countinue.visible = true;
        })
